...
const texture = new THREE.TextureLoader().load("effects/smoke.png", texture => {
...
export const concreteHit = (position: THREE.Vector3, normal: THREE.Vector3, batchSystem: BatchedRenderer) => {
  ...
  smoke.emitter.position.copy(position);
